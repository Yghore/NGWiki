...
<div>
    ...
    <div class="card">
        ...
        <div class="card-footer">
            ...
            <a class="button-icon button-primary" href="{{ route('admin.category.edit') }}"><i class="fas fa-pen"></i></a>
            <a class="button-icon button-danger" href="#"><i class="fas fa-times"></i></a>
        </div>
    </div>
    <div class="card">
        <div class="card-header">
